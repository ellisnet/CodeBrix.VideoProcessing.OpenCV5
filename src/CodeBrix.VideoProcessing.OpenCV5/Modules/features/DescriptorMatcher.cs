...
public class DescriptorMatcher : Algorithm
{
    ...
    /// 
    /// </summary>
    protected DescriptorMatcher(IntPtr rawPtr, Action<IntPtr> release)
        : base(rawPtr, release) { }

    private DescriptorMatcher(IntPtr smartPtr, IntPtr rawPtr)
        : base(smartPtr, rawPtr, p => NativeMethods.HandleException(NativeMethods.features_Ptr_DescriptorMatcher_delete(p)))
    { }
    ...
    internal static DescriptorMatcher FromPtr(IntPtr ptr)
    {
        ...
        NativeMethods.HandleException(NativeMethods.features_Ptr_DescriptorMatcher_get(ptr, out var rawPtr));
        return new DescriptorMatcher(ptr, rawPtr);
    }
    ...
    internal static DescriptorMatcher FromRawPtr(IntPtr ptr)
    {
        ...
        return new DescriptorMatcher(ptr, static _ => { });
    }
