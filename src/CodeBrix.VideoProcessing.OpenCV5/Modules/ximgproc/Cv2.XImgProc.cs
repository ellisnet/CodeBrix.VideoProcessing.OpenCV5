...
public static partial class Cv2
{
    ...
    #pragma warning restore CA1034
        ...
        {
            return CodeBrix.VideoProcessing.OpenCV5.XImgProc.DTFilter.Create(guide, sigmaSpatial, sigmaColor, mode, numIters);
        }
        ...
        {
            return CodeBrix.VideoProcessing.OpenCV5.XImgProc.GuidedFilter.Create(guide, radius, eps);
        }
        ...
        {
            return CodeBrix.VideoProcessing.OpenCV5.XImgProc.FastGlobalSmootherFilter.Create(guide, lambda, sigmaColor, lambdaAttenuation, numIter);
        }
