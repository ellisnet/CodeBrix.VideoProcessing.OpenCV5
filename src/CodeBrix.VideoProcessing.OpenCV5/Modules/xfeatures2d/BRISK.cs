...
namespace CodeBrix.VideoProcessing.OpenCV5.XFeatures2D; //was previously: OpenCvSharp.XFeatures2D;
...
public class BRISK : Feature2D
{
    ...
    private BRISK(IntPtr smartPtr, IntPtr rawPtr)
        : base(smartPtr, rawPtr, p => NativeMethods.HandleException(NativeMethods.xfeatures2d_Ptr_BRISK_delete(p)))
    {
    }
    ...
    public static BRISK Create(int thresh = 30, int octaves = 3, float patternScale = 1.0f)
    {
        NativeMethods.HandleException(
            NativeMethods.xfeatures2d_BRISK_create1(thresh, octaves, patternScale, out var smartPtr));
        NativeMethods.HandleException(
        ...
        IEnumerable<int>? indexChange = null)
    {
        ...
        NativeMethods.HandleException(
            NativeMethods.xfeatures2d_BRISK_create2(
        ...
        IEnumerable<int>? indexChange = null)
    {
        ...
        NativeMethods.HandleException(
            NativeMethods.xfeatures2d_BRISK_create3(
                thresh, octaves,
                radiusListArray, radiusListArray.Length,
                numberListArray, numberListArray.Length,
                dMax, dMin,
