...
public class AgastFeatureDetector : Feature2D
{
    ...
    private AgastFeatureDetector(IntPtr smartPtr, IntPtr rawPtr)
        : base(smartPtr, rawPtr, p => NativeMethods.HandleException(NativeMethods.xfeatures2d_Ptr_AgastFeatureDetector_delete(p)))
    {
    }
        ...
        DetectorType type = DetectorType.OAST_9_16)
    {
        NativeMethods.HandleException(
            NativeMethods.xfeatures2d_AgastFeatureDetector_create(
