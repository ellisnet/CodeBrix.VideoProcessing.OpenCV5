...
/// <summary>
/// Flags for the FontFace-based <see cref="Cv2.PutText(InputOutputArray, string, Point, Scalar, FontFace, int, int, PutTextFlags, CodeBrix.VideoProcessing.OpenCV5.Range?)"/>
