...
/// <summary>
/// TrueType font face used by the FontFace-based <see cref="Cv2.PutText(InputOutputArray, string, Point, Scalar, FontFace, int, int, PutTextFlags, CodeBrix.VideoProcessing.OpenCV5.Range?)"/>
/// and <see cref="Cv2.GetTextSize(Size, string, Point, FontFace, int, int, PutTextFlags, CodeBrix.VideoProcessing.OpenCV5.Range?)"/> (OpenCV 5).
/// </summary>
