...
public static partial class Cv2
{
    ...
    /// cv::xphoto functions
    /// </summary>
    public static partial class XPhoto
    {
        ...
        /// <param name="dst">destination image</param>
        /// <param name="algorithm">see CodeBrix.VideoProcessing.OpenCV5.XPhoto.InpaintTypes</param>
        public static void Inpaint(Mat src, Mat mask, Mat dst, CodeBrix.VideoProcessing.OpenCV5.XPhoto.InpaintTypes algorithm)
        {
            if (src is null)
                throw new ArgumentNullException(nameof(src));
            if (mask is null)
