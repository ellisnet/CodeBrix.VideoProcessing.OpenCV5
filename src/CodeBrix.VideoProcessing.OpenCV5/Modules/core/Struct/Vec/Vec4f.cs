...
public struct Vec4f : IVec<Vec4f, float>, IEquatable<Vec4f>
{
    ...
    /// <returns></returns>
    public readonly Vec4f Add(Vec4f other) => new(
        Item0 + other.Item0,
        Item1 + other.Item1,
        Item2 + other.Item2,
        Item3 + other.Item3);
    ...
    /// <param name="other"></param>
    /// <returns></returns>
    public readonly Vec4f Subtract(Vec4f other) => new(
        Item0 - other.Item0,
        Item1 - other.Item1,
        Item2 - other.Item2,
        Item3 - other.Item3);
    ...
    /// <returns></returns>
    public readonly Vec4f Multiply(double alpha) => new(
        (float)(Item0 * alpha),
        (float)(Item1 * alpha),
        (float)(Item2 * alpha),
        (float)(Item3 * alpha));
    ...
    /// <param name="alpha"></param>
    /// <returns></returns>
    public readonly Vec4f Divide(double alpha) => new(
        (float)(Item0 / alpha),
        (float)(Item1 / alpha),
        (float)(Item2 / alpha),
        (float)(Item3 / alpha));
...
#pragma warning disable 1591
    ...
    public Vec4i ToVec4i() => new((int)Item0, (int)Item1, (int)Item2, (int)Item3);
