...
public class BitmapSourceConverterTests : CodeBrix.VideoProcessing.OpenCV5.Tests.TestBase
{
    [Fact]
    public void BitmapSource8Bit()
    {
        ...
        {
            var bs = CodeBrix.VideoProcessing.OpenCV5.Wpf.BitmapSourceConverter.ToBitmapSource(mat); // PixelFormats.Bgr24
    ...
    public void BitmapSource16Bit()
    {
        ...
        {
            var bs = CodeBrix.VideoProcessing.OpenCV5.Wpf.BitmapSourceConverter.ToBitmapSource(mat); // PixelFormats.Rgb48
    ...
    public void BitmapSourceSample()
    {
        ...
        using (var mat = new Mat(size, size, MatType.CV_8UC3, new Scalar(128, 128, 128)))
        {
            ...
            bs8 = CodeBrix.VideoProcessing.OpenCV5.Wpf.BitmapSourceConverter.ToBitmapSource(mat);
        }
        ...
        using (var mat = new Mat(size, size, MatType.CV_16UC3, new Scalar(32767, 32767, 32767)))
        {
            ...
            bs16 = CodeBrix.VideoProcessing.OpenCV5.Wpf.BitmapSourceConverter.ToBitmapSource(mat);
        }
