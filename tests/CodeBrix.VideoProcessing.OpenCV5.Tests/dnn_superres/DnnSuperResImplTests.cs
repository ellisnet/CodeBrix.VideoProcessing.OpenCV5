using CodeBrix.VideoProcessing.OpenCV5.DnnSuperres;
using Xunit;

namespace CodeBrix.VideoProcessing.OpenCV5.Tests.DnnSuperres; //was previously: OpenCvSharp.Tests.DnnSuperres;

public class DnnSuperResImplTests : TestBase
{
