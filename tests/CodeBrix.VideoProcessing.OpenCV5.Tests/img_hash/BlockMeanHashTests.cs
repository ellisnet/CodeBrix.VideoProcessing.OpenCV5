using System;
using CodeBrix.VideoProcessing.OpenCV5.ImgHash;
using Xunit;

namespace CodeBrix.VideoProcessing.OpenCV5.Tests.ImgHash; //was previously: OpenCvSharp.Tests.ImgHash;

public class BlockMeanHashTests : TestBase
{
    [Fact]
    ...
    public void ComputeMode0()
    {
        ...
        using (var hash = new Mat<byte>())
        {
            ...
            Assert.Equal(
                [243, 61, 243, 61, 195, 63, 226, 151, 226, 159, 250, 223, 50, 206, 18, 231, 130, 226, 130, 227, 130, 243, 130, 243, 2, 243, 2, 87, 2, 127, 2, 47],
                hashArray);
        }
    }
