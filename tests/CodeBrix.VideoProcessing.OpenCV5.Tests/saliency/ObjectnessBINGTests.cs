using System;
using CodeBrix.VideoProcessing.OpenCV5.Saliency;
using Xunit;

namespace CodeBrix.VideoProcessing.OpenCV5.Tests.Saliency; //was previously: OpenCvSharp.Tests.Saliency;

#pragma warning disable CA1707 // Identifiers should not contain underscores

public class ObjectnessBINGTests : TestBase
{
    [Fact]
