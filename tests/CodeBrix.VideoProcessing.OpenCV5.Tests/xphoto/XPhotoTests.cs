...
using CodeBrix.VideoProcessing.OpenCV5.XPhoto;
using Xunit;

namespace CodeBrix.VideoProcessing.OpenCV5.Tests.XPhoto; //was previously: OpenCvSharp.Tests.XPhoto;

// ReSharper disable InconsistentNaming
public class XPhotoTests : TestBase
{
    private readonly ITestOutputHelper testOutputHelper;

    public XPhotoTests(ITestOutputHelper testOutputHelper)
    {
    ...
    public void Inpaint()
    {
        ...
        Cv2.XPhoto.Inpaint(src, mask, dst, CodeBrix.VideoProcessing.OpenCV5.XPhoto.InpaintTypes.SHIFTMAP);
