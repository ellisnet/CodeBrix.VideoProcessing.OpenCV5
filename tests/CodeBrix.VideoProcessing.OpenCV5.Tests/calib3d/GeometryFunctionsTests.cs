...
// Tests for the OpenCV 5 geometry/calib functions added to CodeBrix.VideoProcessing.OpenCV5:
...
public class GeometryFunctionsTests : TestBase
{
    ...
    public void ConvertPointsHomogeneous()
    {
        ...
        // concretely-typed destination to pick a conversion direction), but every CodeBrix.VideoProcessing.OpenCV5
