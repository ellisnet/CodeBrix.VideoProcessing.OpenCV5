...
namespace CodeBrix.VideoProcessing.OpenCV5.Tests.PtCloud; //was previously: OpenCvSharp.Tests.PtCloud;

// Tests for the OpenCV 5 ptcloud mesh / point cloud I/O (loadPointCloud / savePointCloud /
// loadMesh / saveMesh) added to CodeBrix.VideoProcessing.OpenCV5.
public class PtCloudIoTests : TestBase
{
