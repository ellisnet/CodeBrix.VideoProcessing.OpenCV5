...
public class ExceptionTests : TestBase
{
    ...
    public void ArucoDetectMarkers()
    {
        ...
        using var dict = Cv2.Aruco.GetPredefinedDictionary(CodeBrix.VideoProcessing.OpenCV5.Aruco.PredefinedDictionaryType.Dict6X6_250);
        using var detector = new CodeBrix.VideoProcessing.OpenCV5.Aruco.ArucoDetector(dict);
