...
namespace CodeBrix.VideoProcessing.OpenCV5.Tests.Shape; //was previously: OpenCvSharp.Tests.Shape;

#pragma warning disable CA1707 // Identifiers should not contain underscores

public class ThinPlateSplineShapeTransformerTests : TestBase
{
    // ----------------------------------------------------------------
