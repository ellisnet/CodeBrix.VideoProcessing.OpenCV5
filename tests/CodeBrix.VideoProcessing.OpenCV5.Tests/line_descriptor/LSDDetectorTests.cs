...
using CodeBrix.VideoProcessing.OpenCV5.LineDescriptor;
using Xunit;

namespace CodeBrix.VideoProcessing.OpenCV5.Tests.LineDescriptor; //was previously: OpenCvSharp.Tests.LineDescriptor;

// ReSharper disable once InconsistentNaming
public class LSDDetectorTests : TestBase
{
    [Fact]
    public void New()
    {
