...
using System.IO;
using CodeBrix.VideoProcessing.OpenCV5.Aruco;
using Xunit;

namespace CodeBrix.VideoProcessing.OpenCV5.Tests.Aruco; //was previously: OpenCvSharp.Tests.Aruco;

// ReSharper disable once InconsistentNaming
public class ArucoTests : TestBase
{
    // ==================== DetectorParameters ====================
