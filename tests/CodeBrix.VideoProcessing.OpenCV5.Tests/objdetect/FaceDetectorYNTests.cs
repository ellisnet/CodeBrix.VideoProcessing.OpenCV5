...
namespace CodeBrix.VideoProcessing.OpenCV5.Tests.ObjDetect; //was previously: OpenCvSharp.Tests.ObjDetect;

// ReSharper disable InconsistentNaming
public class FaceDetectorYNTests : TestBase
{
