...
namespace CodeBrix.VideoProcessing.OpenCV5.Tests.WeChatQRCode; //was previously: OpenCvSharp.Tests.WeChatQRCode;

#pragma warning disable CA1707 // Identifiers should not contain underscores

public class WeChatQRCodeTests(ITestOutputHelper testOutputHelper) : TestBase
{
    ...
    {
        using var qr = new CodeBrix.VideoProcessing.OpenCV5.WeChatQRCode();
    }
    ...
    public void Constructor_NullArguments_ThrowsArgumentNullException(
        string? a, string? b)
    {
        Assert.Throws<ArgumentNullException>(() => new CodeBrix.VideoProcessing.OpenCV5.WeChatQRCode(a!, b!));
    }
    ...
    private static CodeBrix.VideoProcessing.OpenCV5.WeChatQRCode CreateWithModels() =>
